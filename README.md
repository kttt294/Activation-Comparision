# 🚀 Phân Tích & Đánh Giá Các Hàm Kích Hoạt (Activation Functions) Trong Mạng Nơ-ron Nhân Tạo
...
Dự án này là bài tập lớn thuộc môn **Nhập môn Trí tuệ Nhân tạo**, tập trung vào việc nghiên cứu, cài đặt và phân tích chuyên sâu ảnh hưởng của 4 hàm kích hoạt phổ biến: **Sigmoid, Tanh, ReLU, và Leaky ReLU** đối với hiệu suất và độ ổn định của mạng Multi-Layer Perceptron (MLP) khi huấn luyện trên tập dữ liệu hình ảnh **MNIST**.
...
```text
.
├── config.py           # ⚙️ Cấu hình siêu tham số (Hyperparameters), Seed và Device.
...
├── main.py             # 🏁 Tệp thực thi chính, tự động kích hoạt tuần tự các bài thực nghiệm.
├── requirements.txt    # 📜 Danh sách các thư viện phụ thuộc.
└── BaoCao.docx         # 📝 Báo cáo phân tích chuyên sâu (kèm chứng minh toán học).
```
...
Để kích hoạt quá trình huấn luyện và đánh giá, bạn chỉ cần chạy tệp lệnh duy nhất:
...
4. `fig_05_gradient_evo.png`: Theo dõi quỹ đạo sống sót của Gradient ở lớp đầu tiên trong suốt 50 chu kỳ học.

---

## 👨‍💻 Tác giả
*Dự án thuộc bài tập lớn môn Nhập môn Trí tuệ Nhân tạo.*
